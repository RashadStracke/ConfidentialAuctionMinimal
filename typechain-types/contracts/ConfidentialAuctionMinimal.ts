...
export interface ConfidentialAuctionMinimalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionBids"
      | "auctions"
...
export interface ConfidentialAuctionMinimal extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialAuctionMinimal;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialAuctionMinimalInterface;
