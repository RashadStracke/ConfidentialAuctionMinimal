...
export interface ConfidentialAuctionRealInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionBids"
      | "auctions"
...
export interface ConfidentialAuctionReal extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialAuctionReal;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialAuctionRealInterface;
