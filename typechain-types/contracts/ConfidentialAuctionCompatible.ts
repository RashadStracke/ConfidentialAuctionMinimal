...
export interface ConfidentialAuctionCompatibleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionBids"
      | "auctions"
  ...
  encodeFunctionData(
    functionFragment: "getHighestBidAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ConfidentialAuctionCompatible extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialAuctionCompatible;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialAuctionCompatibleInterface;
  ...
  getHighestBidAmount: TypedContractMethod<
    [_auctionId: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "getHighestBidAmount"
  ): TypedContractMethod<[_auctionId: BigNumberish], [bigint], "view">;
  getFunction(
