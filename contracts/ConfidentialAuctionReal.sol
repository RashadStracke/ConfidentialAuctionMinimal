...
contract ConfidentialAuctionReal is SepoliaConfig {
    ...
    struct Auction {
        ...
        bool isActive;
        uint256 endTime;
        euint64 highestBidAmount; // Encrypted amount
        address highestBidder;
        uint256 bidCount;
        ebool isHighBid; // Encrypted boolean
    }
    ...
    function placeBid(
        ...
        // Encrypt the bid amount and status
    ...
    // View functions that return non-encrypted data
    ...
    function getAuctionInfo(uint256 _auctionId) external view returns (
        ...
        return (
            ...
            auction.creator,
            auction.timestamp,
            auction.isActive && block.timestamp < auction.endTime,
            auction.endTime,
            auction.bidCount
        );
    }
